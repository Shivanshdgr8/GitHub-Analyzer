...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Shivanshdgr8/GitHub-Analyzer.git
   cd GitHub-Analyzer
   ```
...
- GitHub: [@Shivanshdgr8](https://github.com/Shivanshdgr8)
- Project Link: [https://github.com/Shivanshdgr8/GitHub-Analyzer](https://github.com/Shivanshdgr8/GitHub-Analyzer)
...
[Report Bug](https://github.com/Shivanshdgr8/GitHub-Analyzer/issues) • [Request Feature](https://github.com/Shivanshdgr8/GitHub-Analyzer/issues)
