        ...
        >
          ...
          <motion.button
            ...
            className={`p-3 rounded-xl transition-all duration-300 shadow-lg ${
              isDarkMode
                ? 'bg-gradient-to-br from-purple-500 to-violet-500 text-white hover:shadow-purple-500/50'
                : 'bg-gradient-to-br from-purple-600 to-violet-600 text-white hover:shadow-purple-600/50 border border-purple-300'
            }`}
        ...
        >
          <div className="mb-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <motion.input
              ...
              className={`col-span-1 md:col-span-2 p-4 rounded-xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
                isDarkMode
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-4 rounded-xl bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-500 hover:to-violet-500 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
            >
              Fetch
            </motion.button>
          </div>
                ...
                {[
                  ...
                  <motion.div
                    ...
                    className={`p-6 rounded-xl shadow-lg backdrop-blur-sm border ${
                      isDarkMode
                        ? 'bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-slate-700 hover:border-purple-500'
                        : 'bg-gradient-to-br from-gray-50 to-white border-gray-200 hover:border-purple-500 shadow-md'
            ...
            >
              ...
              >
                <motion.input
                  ...
                  className={`p-3 rounded-xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
                    isDarkMode
                      ? 'bg-slate-800/80 border-slate-700 text-white placeholder-slate-400 backdrop-blur-sm'
                      : 'bg-white border-gray-300 text-gray-900 placeholder-gray-400 shadow-md'
                  }`}
